...
![Hurricane Maria tide gauge locations](./maria_locations.png)
*Puerto Rico tide gauge locations affected by Hurricane Maria*
...
![Correlation results for ECCO and UHSLC SSH data](./timeseries_corr.png)
*Correlation results for ECCO and UHSLC SSH data*
...
![Bland-Altman plots for Arecibo, Esperanza, Isabel Segunda and Mayaguez](./bland_altman_plots.png)
*Bland-Altman plots for Arecibo, Esperanza, Isabel Segunda and Mayaguez*
...
![Time series ECCO SSH during Hurricane Maria](./timeseries_ECCO_Maria.png)
*Time series ECCO SSH during Hurricane Maria*
...
![Time series UHSLC SSH during Hurricane Maria](./timeseries_TG_Maria.png)
*Time series UHSLC SSH during Hurricane Maria*
...
![Time series ECCO and UHSLC SSH comparison during Hurricane Maria (normalized, resampled)](./timeseries_TG&ECCO_resampled_during_Maria.png)
*Time series ECCO and UHSLC SSH comparison during Hurricane Maria (normalized, resampled)*
...
![Time series ECCO and UHSLC SSH comparison during Hurricane Maria (normalized, not resampled)](./timeseries_TG&ECCO_during_Maria.png)
*Time series ECCO and UHSLC SSH comparison during Hurricane Maria (normalized, not resampled)*
...
![Time series SSH rolling mean comparisons](./all_TGs_rolling_mean.png)
*Time series SSH rolling mean comparisons*
...
![Time series SSH rolling standard deviation comparisons](./all_TGs_rolling_std.png)
*Time series SSH rolling standard deviation comparisons*
...
![Time series SSH comparison for Esperanza](./timeseries_esperanza.png)
*Time series SSH comparison for Esperanza*

![Time series SSH comparison for Fajardo](./timeseries_fajardo.png)
*Time series SSH comparison for Fajardo*
...
![Rolling mean and rolling STD time series correlation](./timeseries_entire_dataset_corr.png)
*Rolling mean and rolling STD time series correlation*
